...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "mock-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "mock-upload-list-item", key: item.uid },
